...
def main():
    ...
    train_aug_loader = DataLoader(getImageLabel(augmented=f'D:/Kampus/tugas/SMT 3/IPSD/Teori/TRIAL WEEK10/DATASET/Augmented Images/Augmented Images/FOLDS_AUG/', folds=folds, subdir=['Train']), batch_size=BATCH_SIZE, shuffle=True)
    train_ori_loader = DataLoader(getImageLabel(original=f'D:/Kampus/tugas/SMT 3/IPSD/Teori/TRIAL WEEK10/DATASET/Original Images/Original Images/FOLDS/', folds=folds, subdir=['Train']), batch_size=BATCH_SIZE, shuffle=True)
    vali_loader = DataLoader(getImageLabel(original=f'D:/Kampus/tugas/SMT 3/IPSD/Teori/TRIAL WEEK10/DATASET/Original Images/Original Images/FOLDS/', folds=folds, subdir=['Valid']), batch_size=BATCH_SIZE, shuffle=False)
